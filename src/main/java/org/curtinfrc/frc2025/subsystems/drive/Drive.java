...
public class Drive extends SubsystemBase {
  ...
  private final PIDController xFollower = new PIDController(1.5, 0, 0);
  private final PIDController yFollower = new PIDController(1.5, 0, 0);
  private final PIDController headingFollower = new PIDController(2, 0, 0);
