...
public class Robot extends LoggedRobot {
  ...
  //   LoggedNetworkSetpoint networkHpSetpoint = new LoggedNetworkSetpoint("HPSetpoint",
  // hpSetpoint);
  ...
  public Robot() {
    ...
    // atHpSetpoint =
    //     drive.atSetpoint.and(new Trigger(() ->
    // drive.setpoint.equals(hpSetpoint.driveSetpoint())));
    ...
    elevator.setDefaultCommand(elevator.setVoltage(() -> controller.getLeftY() * 5));
    climber.setDefaultCommand(climber.setVoltage(() -> controller.getRightY() * 5));
    ...
    //     .whileTrue(
    //         Commands.runOnce(
    //                 () -> hpSetpoint = new Setpoint(ElevatorSetpoints.BASE,
  ...
  public void teleopInit() {
    ...
    //             .until(controller.povRight())
    //             .andThen(elevator.goToSetpoint(ElevatorSetpoints.L3))
    //             .andThen(climber.goToSetpoint())
    //             .andThen(elevator.goToSetpoint(ElevatorSetpoints.BASE)));
  }
