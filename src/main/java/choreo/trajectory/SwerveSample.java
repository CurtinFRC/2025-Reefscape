...
public class SwerveSample implements TrajectorySample<SwerveSample> {
  ...
  public SwerveSample interpolate(SwerveSample endValue, double timestamp) {
    ...
    double lerpedVXPos_1 = vx;
    double lerpedVYPos_1 = vy;
    double lerpedXPos = x;
    double lerpedYPos = y;
    ...
    while (true) {
      ...
      if (intTime >= lerpedTimestamp - 0.01) {
        ...
        lerpedXPos += lerpedVXPos_1 * dt;
        lerpedYPos += lerpedVYPos_1 * dt;
        break;
      }

      lerpedVXPos_1 = lerpedVXPos;
      lerpedVYPos_1 = lerpedVYPos;
