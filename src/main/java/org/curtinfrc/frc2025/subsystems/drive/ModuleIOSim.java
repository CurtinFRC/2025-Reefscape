...
public class ModuleIOSim implements ModuleIO {
  ...
  public ModuleIOSim(SwerveModuleSimulation moduleSimulation) {
    ...
    this.driveMotor =
        moduleSimulation
            ...
            .withCurrentLimit(
                Amps.of(org.curtinfrc.frc2025.generated.TunerConstants.FrontLeft.SlipCurrent));
    this.turnMotor = moduleSimulation.useGenericControllerForSteer().withCurrentLimit(Amps.of(20));

    this.driveController = new PIDController(DRIVE_KP, 0, DRIVE_KD);
    this.turnController = new PIDController(TURN_KP, 0, TURN_KD);
  ...
  public void updateInputs(ModuleIOInputs inputs) {
    ...
    inputs.odometryTimestamps =
        org.curtinfrc.frc2025.util.PhoenixUtil.getSimulationOdometryTimeStamps();
