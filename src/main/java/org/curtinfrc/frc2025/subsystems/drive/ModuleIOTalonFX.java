...
public class ModuleIOTalonFX implements ModuleIO {
  ...
  public void updateInputs(ModuleIOInputs inputs) {
    // Update drive inputs
    inputs.driveConnected = driveConnectedDebounce.calculate(driveVelocity.getStatus().isOK());
    ...
    // Update turn inputs
    inputs.turnConnected = turnConnectedDebounce.calculate(turnVelocity.getStatus().isOK());
