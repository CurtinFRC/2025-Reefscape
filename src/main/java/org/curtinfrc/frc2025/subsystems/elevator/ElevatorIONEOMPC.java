...
public class ElevatorIONEOMPC extends ElevatorIONEO {
  ...
  public void updateInputs(ElevatorIOInputs inputs) {
    ...
    inputs.point = set;
    inputs.pointRot = set.elevatorSetpoint();
    ...
    inputs.positionError = Math.abs(elevatorEncoder.getPosition() - set.elevatorSetpoint());
  ...
  public void goToSetpoint(Setpoints point) {
    ...
    double targetPosition = point.elevatorSetpoint();
